...
var (
	...
	Import           = op.Capture{Name: "Import", Value: op.And{"import", Sp, op.Optional{Value: op.And{ImportService, Sp}}, Text}}
	ImportService    = op.Capture{Name: "ImportService", Value: "service"}
	...
	LineCommentText  = op.Capture{Name: "LineCommentText", Value: op.ZeroOrMore{Value: op.Or{op.RuneRange{Min: 0x00, Max: 0x09}, op.RuneRange{Min: 0x0B, Max: 0x0C}, op.RuneRange{Min: 0x0E, Max: 0x10FFFF}}}}
	LineComment      = op.And{"//", LineCommentText, op.Optional{Value: Nl}}
	BlockCommentText = op.Capture{Name: "BlockCommentText", Value: op.ZeroOrMore{Value: op.Or{op.RuneRange{Min: 0x00, Max: 0x29}, op.RuneRange{Min: 0x2B, Max: 0x10FFFF}, op.And{rune(0x2A), op.Or{op.RuneRange{Min: 0x00, Max: 0x29}, op.RuneRange{Min: 0x2B, Max: 0x2E}, op.RuneRange{Min: 0x30, Max: 0x10FFFF}}}}}}
	BlockComment     = op.And{"/*", BlockCommentText, op.OneOrMore{Value: rune(0x2A)}, '/'}
	Comment          = op.Or{LineComment, BlockComment}

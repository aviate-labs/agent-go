...
type MixedHashTree struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to TreeEnum:
	//
	//	*MixedHashTree_Empty
	//	*MixedHashTree_Fork_
...
func (x *MixedHashTree) GetEmpty() *emptypb.Empty {
	if x != nil {
		if x, ok := x.TreeEnum.(*MixedHashTree_Empty); ok {
			return x.Empty
		}
	}
	return nil
...
func (x *MixedHashTree) GetFork() *MixedHashTree_Fork {
	if x != nil {
		if x, ok := x.TreeEnum.(*MixedHashTree_Fork_); ok {
			return x.Fork
		}
	}
	return nil
...
func (x *MixedHashTree) GetLabeled() *MixedHashTree_Labeled {
	if x != nil {
		if x, ok := x.TreeEnum.(*MixedHashTree_Labeled_); ok {
			return x.Labeled
		}
	}
	return nil
...
func (x *MixedHashTree) GetLeafData() []byte {
	if x != nil {
		if x, ok := x.TreeEnum.(*MixedHashTree_LeafData); ok {
			return x.LeafData
		}
	}
	return nil
...
func (x *MixedHashTree) GetPrunedDigest() []byte {
	if x != nil {
		if x, ok := x.TreeEnum.(*MixedHashTree_PrunedDigest); ok {
...
func (x *MixedHashTree) GetTreeEnum() isMixedHashTree_TreeEnum {
	if x != nil {
		return x.TreeEnum
	}
	return nil

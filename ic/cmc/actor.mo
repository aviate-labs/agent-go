...
actor class _cmc() : async actor {} {
    public shared func notify_top_up(_arg0 : T.NotifyTopUpArg) : async (T.NotifyTopUpResult) {
        (#Ok(13928505266879913405))
    };
    public shared func create_canister(_arg0 : T.CreateCanisterArg) : async (T.CreateCanisterResult) {
        (#Ok(principalOfBlob("xBDDD886CBEFD4B2A492BD37EED100C4A92C2724DFDEEA442723ED5975AE7B291")))
    };
    public shared func notify_create_canister(_arg0 : T.NotifyCreateCanisterArg) : async (T.NotifyCreateCanisterResult) {
        (#Ok(principalOfBlob("xBDDD886CBEFD4B2A492BD37EED100C4A92C2724DFDEEA442723ED5975AE7B291")))
    };
    public shared func notify_mint_cycles(_arg0 : T.NotifyMintCyclesArg) : async (T.NotifyMintCyclesResult) {
        (#Ok({ block_index = 13928505266879913405; minted = 17010356921542854954; balance = 9294670361248549388 }))
    };
